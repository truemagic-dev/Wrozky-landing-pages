...
Array.prototype.forEach.call(togglers,function(toggler){toggler.addEventListener('click',function(){var target=toggler;if(accordion==="true"){Array.prototype.forEach.call(togglers,function(header){if(target!==header){header.classList.remove('t849__opened');t849_slideUp(header.nextElementSibling,target)}})}
...
function t1061_initThumbnail(rec){t_onFuncLoad('t1061_setThumbnailHeight',function(){t1061_setThumbnailHeight(rec)});t_onFuncLoad('t1061_setThumbnail',function(){t1061_setThumbnail(rec)});t_onFuncLoad('t1061_setYouTubeIframeHeight',function(){t1061_setYouTubeIframeHeight(rec)})}
